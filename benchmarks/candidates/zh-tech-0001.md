...
仓库使用 Semantic Versioning。当前版本号只放在 [VERSION](./VERSION)，版本变更记录放在 [CHANGELOG.md](./CHANGELOG.md)。发布新版本时，更新 `VERSION` 与 `CHANGELOG.md` 并推到 `main`；`.github/workflows/release.yml` 会自动打 `v<version>` tag 并生成 GitHub Release。
