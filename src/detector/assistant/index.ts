/**
 * Assistant behaviour detector family
 *
 * Chat behaviour rather than prose shape. This is the family the upstreams handle worst.
 *
...
export const FAMILY: DetectorFamily = 'assistant';
